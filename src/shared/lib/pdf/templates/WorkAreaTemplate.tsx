		...
		<Document>
			...
			<Page size="A4" style={baseStyles.page}>
				...
				{LAB_RULES.general.map((rule, ruleIndex) => (
					<Text
						key={`general-${rule.slice(0, 20).replace(/\s/g, "-")}`}
						style={workAreaStyles.ruleText}
					>
						<Text style={workAreaStyles.ruleNumber}>1.{ruleIndex + 1}</Text>{" "}
						{rule}
					</Text>
				))}
				...
				{LAB_RULES.ppe.map((rule, ruleIndex) => (
					<Text
						key={`ppe-${rule.slice(0, 20).replace(/\s/g, "-")}`}
						style={workAreaStyles.ruleText}
					>
						<Text style={workAreaStyles.ruleNumber}>2.{ruleIndex + 1}</Text>{" "}
						{rule}
					</Text>
				))}
			...
			<Page size="A4" style={baseStyles.page}>
				...
				{LAB_RULES.chemicals.map((rule, ruleIndex) => (
					<Text
						key={`chemical-${rule.slice(0, 20).replace(/\s/g, "-")}`}
						style={workAreaStyles.ruleText}
					>
						<Text style={workAreaStyles.ruleNumber}>3.{ruleIndex + 1}</Text>{" "}
						{rule}
					</Text>
				))}
				...
				{LAB_RULES.emergency.map((rule, ruleIndex) => (
					<Text
						key={`emergency-${rule.slice(0, 20).replace(/\s/g, "-")}`}
						style={workAreaStyles.ruleText}
					>
						<Text style={workAreaStyles.ruleNumber}>4.{ruleIndex + 1}</Text>{" "}
						{rule}
					</Text>
				))}
