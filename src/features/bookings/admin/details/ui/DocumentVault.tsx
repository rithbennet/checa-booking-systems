...
export function DocumentVault({ booking }: DocumentVaultProps) {
    ...
    const regenerateForm = useRegenerateForm();
    ...
    const handlePreviewForm = (url: string | null | undefined, name: string) => {
        if (!url) {
            console.error(
                `[DocumentVault] Preview failed: URL is missing for document "${name}"`,
            );
    ...
    const handleDownloadForm = async (
        ...
        try {
            ...
            console.error("Download failed:", { url, fileName, error: err });
                                ...
                                verifySignature.mutate(formNeedingVerification.id, {
                                    onSuccess: () => {
                                        toast.success("Signature verified successfully", {
                                            description:
                                                "The signed forms have been verified and the booking can proceed.",
                                        });
                                    },
                                    onError: (error) => {
                        ...
                        >
                            ...
                            <Button
                                ...
                                onClick={() => {
                                    ...
                                    regenerateForm.mutate(
                                        { formId: form.id, bookingId: booking.id },
                                        {
                                            onSettled: () => {
